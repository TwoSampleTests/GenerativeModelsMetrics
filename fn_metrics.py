...
class FNMetric(TwoSampleTestBase):
    ...
    def Test_tf(self, max_vectorize: int = 100) -> None:
        ...
        def set_dist_num_from_symb(dist: DistTypeTF,
            ...
            dist_num: tf.Tensor = generate_and_clean_data(dist, nsamples, nsamples, dtype = self.Inputs.dtype, seed = int(seed), mirror_strategy = self.Inputs.mirror_strategy) # type: ignore
            return dist_num
